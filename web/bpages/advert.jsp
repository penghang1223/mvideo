...
%>
<%
    List<Advert> advert = (List<Advert>) request.getAttribute("advert");
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../../index.html"><i class="fa fa-circle-o"></i> guan</a></li>
                        <li><a href="../../index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="AdvertServlet">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                <tr> <button id="addbtn" type="button" class="btn btn-primary btn-default btn-block">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%=advert.get(i).getName()%>
                                    </td>
                                    <td>
                                        <%=advert.get(i).getUrl()%>
                                    </td>
                                    <td>
                                        <%=advert.get(i).getCoverPic()%>
                                    </td>
                                    <td>
...
<script>
    $(function () {
        ...
        $("#addbtn").click(function () {
            window.location.href = "bpages/insertadvert.jsp";
        });

        //修改按钮
        $(".upbtn").on('click', function () {
            var id = $($(this).parents("tr").children("td")[0]).html().trim();
            window.location.href = "http://localhost:8080/mvideo/QueryAdvertServlet?advertId=" + id;
        });
        //删除按钮
        $(".delbtn").on('click', function () {
            var id = $($(this).parents("tr").children("td")[0]).html().trim();
            window.location.href = "http://localhost:8080/mvideo/DeleteAdvertServlet?adverId=" + id;
        });
    });
</script>
</body>
