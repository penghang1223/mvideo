        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="ModifyAdvertServlet" method="get">
         <span style="display: none" id="upsp">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <tr>
                                    <td><input name="advert_id1" type="text" value="<%=advert.getId()%>" /></td>
                                    <td><input name="advert_name1" type="text" value="<%=advert.getName()%>" /></td>
                                    <td><input name="advert_url1" type="text" value="<%=advert.getUrl()%>" /></td>
                                    <td><input name="advert_coverPic1" type="text" value="<%=advert.getCoverPic()%>" /></td>
                                    <td> <button type="submit" class="btn btn-block btn-default btn-primary" >修改</button>
...
<script>
    $(function () {
        ...
        $("#cancel").click(function () {
            window.location.href = "http://localhost:8080/mvideo/AdvertServlet";
        });
    });
</script>
