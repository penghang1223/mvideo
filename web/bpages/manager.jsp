                ...
                <li class="treeview">
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> 管理员管理</a></li>
                        <li><a href="../charts/morris.html"><i class="fa fa-circle-o"></i> 用户管理</a></li>
                        <li><a href="../charts/flot.html"><i class="fa fa-circle-o"></i> 角色管理</a></li>
                        <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i> 分类管理</a></li>
                        <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i> 权限管理</a></li>
                        <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i> 日志管理</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../UI/general.html"><i class="fa fa-circle-o"></i> 视频管理</a></li>
                        <li><a href="../UI/icons.html"><i class="fa fa-circle-o"></i> 订单管理</a></li>
                        <li><a href="../UI/buttons.html"><i class="fa fa-circle-o"></i> 友情链接管理</a></li>
                    </ul>
                </li>
            </ul>
        </section>
