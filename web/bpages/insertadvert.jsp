...
<%--                                </tr>--%>
                               <tr>
                                   <td><input name="advert_id" type="text" value=""/></td>
                                   <td><input name="advert_name" type="text" value=""/></td>
                                   <td><input name="advert_url" type="text" value=""/></td>
                                   <td><input name="advert_coverPic" type="text" value=""/></td>
                                   <td>
